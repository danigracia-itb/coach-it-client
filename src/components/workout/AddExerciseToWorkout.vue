<template>
    ...
    <div class="modal fade" id="addExerciseModal" tabindex="-1"
        ...
        aria-labelledby="addExerciseModal" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div v-for="(exercises, group) in exercises"
                        ...
                        <div class="exercises-grid">
                            <button
                                ...
                                :disabled="workout.find(w => w.exercise_id == exercise.id)"
                                >
                                <span v-if="selectedExercises.some(e => e === exercise)">{{  selectedExercises.findIndex(e => e === exercise)  + 1}}</span>
                                {{ exercise.name }}
                            </button>
                        </div>
                    </div>
