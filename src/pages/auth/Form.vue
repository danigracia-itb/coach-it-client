<template>
    ...
    >
      ...
      >
        ...
        <fieldset v-if="currentPage === 1" class="form-page">
          ...
          <div class="form-group mt-5">
            <label for="bodyWeight" class="text-black">Body Weight (kg)</label>
            <input
              type="number"
              id="bodyWeight"
              class="form-control"
                ...
                <tr>
                  ...
                  <td>
                    <input
                      ...
                      name="day"
                      value="Tuesday"
                      v-model="train_available_days.tuesday"
                    />
                  </td>
                  <td>
                    <input
                      ...
                      name="day"
                      value="Wednesday"
                      v-model="train_available_days.wednesday"
                    />
                  </td>
                  <td>
                    <input
                      ...
                      name="day"
                      value="Thursday"
                      v-model="train_available_days.thursday"
                    />
                  </td>
                  <td>
                    <input
                      ...
                      name="day"
                      value="Friday"
                      v-model="train_available_days.friday"
                    />
                  </td>
                  <td>
                    <input
                      ...
                      name="day"
                      value="Saturday"
                      v-model="train_available_days.saturday"
                    />
                  </td>
                  <td>
                    <input
                      ...
                      name="day"
                      value="Sunday"
                      v-model="train_available_days.sunday"
                    />
                  </td>
                </tr>
              </tbody>
  ...
  const validateDate = () => {
    ...
    // Compara las fechas asegurándote de que la fecha seleccionada sea hoy o en el pasado
    if (selectedDate >= currentDate) {
      // La fecha es válida, así que puedes restablecer cualquier mensaje de error existente
      errors.date_birth = false;
    }
