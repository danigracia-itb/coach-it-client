...
const routes = [
  ...
  //PRIVATE PART
  {
    ...
    children: [
      ...
      {
        path: "athlete/:id/profile",
        component: () => import("./pages/coach/athlete/AthleteProfile.vue"),
      },
      {
  ...
  //PRIVATE PART ATHLETE
  {
    ...
    children: [
      ...
      {
        path: "calendar",
        component: () => import("./pages/athlete/Calendar.vue"),
      },
      {
        path: "profile",
        component: () => import("./pages/athlete/Profile.vue"),
      },
      {
